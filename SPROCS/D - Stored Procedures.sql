...
-- The error from running the line above was generated by the Position table.
...
-- attempting to do so would "lose" data (the string value would be "truncated").
...
SELECT * FROM Activity WHERE ClubId = 'CSS'
